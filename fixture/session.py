...
class SessionHelper():
    ...
    def Login(self, email, password):
        self.app.driver.get("https://www.postable.com/login")
    ...
    def Logout(self):
        self.app.driver.find_element(By.CSS_SELECTOR, 'li.main-header__link.main-header__link--account>a').click()
        self.app.driver.find_element(By.CSS_SELECTOR, 'li.main-header__link.main-header__link--account>div>ul>li:nth-child(8)>a').click()
